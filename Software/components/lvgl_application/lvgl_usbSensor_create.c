...
static void pannel_VoltAndCurrInfo_Display(lv_obj_t* parent)
{
    ...
    lv_label_set_text(label_voltageNumb,"Error");
    ...
    lv_label_set_text(label_currentNumb,"Error");
...
static void pannel_PowAndResInfo_Display(lv_obj_t* parent)
{
    ...
    lv_label_set_text(label_wattNumb,"Unknow");
    ...
    lv_label_set_text(label_ohmNumb,"Unknow");
