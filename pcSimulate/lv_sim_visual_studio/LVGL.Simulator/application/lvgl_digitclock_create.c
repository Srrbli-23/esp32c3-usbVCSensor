...
void digitclock_sntpState(uint8_t state)
{
    ...
    case USER_SNTP_CONNECT_WAIT:
        lv_label_set_text(label_QnQ, "0.0");
        break;
...
void digitclock_setTempHumi(int32_t temp, uint32_t humi)
{
    if (temp < 0)
    {
...
static void panel_DigitClock_create(lv_obj_t* parent)
{
    ...
    lv_label_set_text(label_clkhour, "01");
    ...
    lv_label_set_text(label_clkminute, "31");
    ...
    lv_label_set_text(label_clksecond, "45");
...
static void panel_DateDis_create(lv_obj_t* parent)
{
    ...
    lv_label_set_text(label_dateStr, "2022/05/23");
